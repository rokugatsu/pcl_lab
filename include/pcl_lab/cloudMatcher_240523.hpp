...
class CloudMatcher : public rclcpp::Node
{
  ...
  private:
    ...
    //geometry_msgs::msg::PoseWithCovarianceStamped posePre_;
    ...
    //boost::shared_ptr<pclomp::MultiGridNormalDistributionsTransform<pcl::PointXYZ, pcl::PointXYZ>> ptr_ndt_omp_;
                              
    //boost::shared_ptr<pclomp::GeneralizedIterativeClosestPoint<pcl::PointXYZ, pcl::PointXYZ>> ptr_gicp_omp_;
    ...
    // Eigen::Vector2d x_Z_tmp_;
    // Eigen::Vector2d x_Zxyz_pre_;
